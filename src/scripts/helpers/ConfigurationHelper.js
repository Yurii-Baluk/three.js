const { Configuration, gridSpacing, snapTolerance, rotationValue, boundsY, boundsX, dragOnlyY, dragOnlyX, directionalDrag, snapToGrid } = require("../core/configuration");
...
export class ConfigurationHelper {
    ...
    get rotationValue(){
        return this.__rotationValue;
    }

    set rotationValue(value){
        this.__rotationValue = value;
        Configuration.setValue(rotationValue, value);
    }
